...
// document.addEventListener('scroll', scrollMenuHandler)
...
//         headerTop.style.backgroundColor = "rgb(30, 136, 229)";
//     }
//     else {
//         headerTop.style.backgroundColor = '#81D4FA'
//     }
// }
...
function showProducts() {
    ...
    productsArray.forEach(function (product) {
        ...
        productsContent.append(newDivItem);
...
function showCartHandler() {
    ...
    basket.forEach(function (basketProduct) {
        ...
        cartContent.append(newDivcontent);
